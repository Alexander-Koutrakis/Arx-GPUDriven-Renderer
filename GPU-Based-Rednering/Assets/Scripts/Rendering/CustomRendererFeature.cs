...
namespace Rendering
{
    ...
    public class CustomRendererFeature : ScriptableRendererFeature
    {
        ...
        public static CustomRendererFeature Instance { get; private set; }
        ...
        private CustomCullingPass cullingPass;
        private CustomRenderPass opaqueRenderPass;
        private CustomRenderPass transparentRenderPass;
        ...
        public override void Create()
        {
            ...
            opaqueRenderPass=new CustomRenderPass();
            CreateOpaqueDrawingPass(opaqueRenderPass,opaqueDrawingSettings);

            transparentRenderPass=new CustomRenderPass();
        ...
        private void CreateCullingPass()
        {
            ...
            cullingPass = new CustomCullingPass();
            cullingPass.SetupRenderPass(modelData, cullingSettings, computeBuffers, copyDepthTextureHandle);
        }
        private void CreateOpaqueDrawingPass(CustomRenderPass renderPass,CustomRendererSettings settings)
        {
        ...
        private void CreateTransparentDrawingPass(CustomRenderPass renderPass, CustomRendererSettings settings)
        {
            ComputeBuffer[] computeBuffers = new ComputeBuffer[5]
          {
                vertexBuffer,
